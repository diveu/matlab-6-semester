function varargout = front_Functional1(varargin)
    gui_Singleton = 1;
    gui_State = struct('gui_Name',       mfilename, ...
                       'gui_Singleton',  gui_Singleton, ...
                       'gui_OpeningFcn', @front_Functional1_OpeningFcn, ...
                       'gui_OutputFcn',  @front_Functional1_OutputFcn, ...
                       'gui_LayoutFcn',  [] , ...
                       'gui_Callback',   []);
...
function front_Functional1_OpeningFcn(hObject, eventdata, handles, varargin)
    guidata(hObject, handles);

function varargout = front_Functional1_OutputFcn(hObject, eventdata, handles) 
