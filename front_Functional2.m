function varargout = front_Functional2(varargin)
    gui_Singleton = 1;
    gui_State = struct('gui_Name',       mfilename, ...
                       'gui_Singleton',  gui_Singleton, ...
                       'gui_OpeningFcn', @front_Functional2_OpeningFcn, ...
                       'gui_OutputFcn',  @front_Functional2_OutputFcn, ...
                       'gui_LayoutFcn',  [] , ...
                       'gui_Callback',   []);
...
function front_Functional2_OpeningFcn(hObject, eventdata, handles, varargin)
    handles.output = hObject;
    guidata(hObject, handles);

function varargout = front_Functional2_OutputFcn(hObject, eventdata, handles) 
